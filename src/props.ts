...
export function convertAttributeValue(name: string, value: string | null, type: PropType): string | boolean | number | undefined {
	if (isBoolean(type)) {
...
function getInvalidTypeMessage(
	...
	return `Invalid prop: type check failed for prop "${name}". Expected ${capitalize(expectedType)} with value ${expectedValue}`
}
